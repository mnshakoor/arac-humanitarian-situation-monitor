...
for(const marker of ['ahsm-shell-v090-rc1-r1','X-AHSM-Source','offline-cache','ignoreSearch:true','./js/v081.js','./js/v083.js','./js/v09.js'])if(!sw.includes(marker))throw new Error(`Service-worker RC1 diagnostics missing ${marker}`);

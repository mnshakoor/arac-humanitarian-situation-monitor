...
snapshot.provenance={...(snapshot.provenance||{}),countryEnrichment:'Daily/manual isolated ReliefWeb country profile pass',countryProfileLimit:LIMIT,reportThumbnailSource:'ReliefWeb file.preview preferred; report image fallback; invalid previews suppressed in UI'};
